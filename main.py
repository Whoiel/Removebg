...
TOKEN = '6535715424:AAHd9zo5U2LaB8wqg6yraaYTY1EFCXwXuGc'
bot = telebot.TeleBot(TOKEN)

# Ganti 'TOKEN_REMOVEBG_API' dengan token API Remove.bg Anda
REMOVEBG_API_KEY = 'G6EnN9JABP9uMtPAffyr1cVw'

@bot.message_handler(commands=['start', 'help'])
def send_welcome(message):
    bot.reply_to(message, "Halo! selamat datang,Kirimkan gambarnya bro untuk menghapus backgroundnya.")
